          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="https://wa.me/+50495924662"
                  className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-medium px-6 py-3 rounded-lg transition-all duration-200"
                >
