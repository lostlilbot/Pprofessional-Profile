    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="relative bg-gradient-to-br from-blue-950 via-blue-900 to-slate-900 text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 md:py-32 lg:py-40">
          <div className="max-w-3xl">
            <p className="text-teal-400 font-medium tracking-wider uppercase mb-4 text-sm md:text-base">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 bg-teal-500 hover:bg-teal-400 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
              ...
              <a
                href="#expertise"
                className="inline-flex items-center justify-center gap-2 border-2 border-blue-700 hover:border-blue-600 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-200"
              >
                View Expertise
              </a>
            </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-stone-50 rounded-2xl p-8 md:p-12 border-l-4 border-teal-600">
            ...
            <div className="flex flex-wrap gap-3">
              {technicalSkills.map((skill, index) => (
                <details key={index} className="group">
                  <summary className="bg-blue-900 text-white px-5 py-2.5 rounded-full font-medium text-sm md:text-base cursor-pointer list-none flex items-center gap-2 hover:bg-blue-800 transition-colors">
                    {skill.name}
                    <svg className="w-4 h-4 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
                  <div className="mt-2 bg-blue-800 text-blue-100 px-4 py-3 rounded-lg text-sm">
                    {skill.description}
                  </div>
                </details>
              ))}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {professionalSkills.map((skill, index) => (
                <details key={index} className="group">
                  <summary className="bg-teal-600 text-white px-5 py-2.5 rounded-full font-medium text-sm md:text-base cursor-pointer list-none flex items-center gap-2 hover:bg-teal-500 transition-colors">
                    {skill.name}
                    <svg className="w-4 h-4 transition-transform group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                  </summary>
                  <div className="mt-2 bg-teal-100 text-teal-800 px-4 py-3 rounded-lg text-sm">
                    {skill.description}
                  </div>
                </details>
              ))}
              ...
              {workHistory.map((item, index) => (
                ...
                >
                  ...
                  <div className={`absolute left-4 md:left-1/2 w-4 h-4 rounded-full transform -translate-x-1/2 z-10 ${
                    item.highlighted ? 'bg-teal-500' : 'bg-slate-400'
                  }`}></div>
                  ...
                  <div className={`ml-12 md:ml-0 md:w-1/2 ${
                    ...
                    <div className={`bg-stone-50 rounded-xl p-6 ${
                      item.highlighted ? 'ring-2 ring-teal-500' : ''
                    }`}>
      ...
      {/* Expertise Dashboard */}
      <section id="expertise" className="py-16 md:py-24 bg-blue-950 text-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {expertise.map((item, index) => (
              <div
                key={index}
                className="bg-blue-900 rounded-xl p-6 hover:bg-blue-800 transition-all duration-300 hover:-translate-y-1"
              >
      ...
      <footer className="bg-blue-950 text-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <div>
              <h3 className="font-serif text-xl font-bold mb-6 text-teal-400">
                Contact Information
              </h3>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a 
                    href="https://wa.me/50495924662" 
                    className="text-blue-300 hover:text-teal-400 transition-colors"
                  >
                    +504 9592-4662
                  </a>
                </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <a
                  href="https://wa.me/50495924662"
                  className="inline-flex items-center gap-2 text-blue-300 hover:text-teal-400 transition-colors"
                >
